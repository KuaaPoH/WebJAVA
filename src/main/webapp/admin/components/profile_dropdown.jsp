...
<div id="dropdownProfile" class="w-[280px] p-4 bg-white dark:bg-neutral-700 rounded-lg shadow-lg hidden">
    ...
    <ul class="py-3 px-0 flex flex-col gap-2">
        <li>
            <a href="#" class="flex items-center gap-2 hover:bg-neutral-100 hover:text-primary-600 rounded-md p-2 text-neutral-600 dark:text-neutral-200 dark:hover:bg-neutral-800">
