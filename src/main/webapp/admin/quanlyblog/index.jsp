    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            ...
            <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
                <h6 class="text-xl font-semibold mb-0 dark:text-white">Danh Sách Blog</h6>
                <ul class="flex items-center gap-[6px]">
                    ...
                    <li class="text-neutral-500 dark:text-neutral-400 font-medium">Quản Lý Blog</li>
                </ul>
            </div>
                ...
                <div class="col-span-12">
                    <div class="card border-0 overflow-hidden">
                        <div class="card-header flex items-center justify-between">
                            <h6 class="card-title mb-0 text-lg">Dữ Liệu Blog</h6>
                            <a href="${pageContext.request.contextPath}/admin/quanlyblog?action=create" class="btn btn-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-lg flex items-center gap-2">
                            ...
                            <table id="selection-table" class="table border border-neutral-200 dark:border-neutral-600 rounded-lg border-separate">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="text-neutral-800 dark:text-white">Ngày Tạo</th>
                                ...
                                <tbody>
                                    <c:forEach items="${listB}" var="b">
                                        <tr>
                                            <td>${b.blogId}</td>
                                            <td>
                                                <h6 class="text-base mb-0 font-medium whitespace-normal" style="max-width: 350px;">${b.title}</h6>
                                            </td>
                                            <td>
                                                <img src="${pageContext.request.contextPath}/assets/images/blogs/${b.image}" alt="${b.title}" class="shrink-0 rounded-lg w-16 h-16 object-cover" onerror="this.src='${pageContext.request.contextPath}/assets/images/logo-icon.png'">
                                            </td>
                                             <td>${b.createdDate}</td>
                                            <td>
                                                <c:if test="${b.active}">
                                            ...
                                            <td>
                                                <div class="flex items-center justify-center gap-2">
                                                    <!-- Toggle Status -->
                                                    <a href="${pageContext.request.contextPath}/admin/quanlyblog?action=toggle&id=${b.blogId}" 
                                                       ...
                                                       title="${b.active ? 'Ẩn blog này' : 'Hiện blog này'}">
                                                        <c:if test="${b.active}">
                                                    ...
                                                    <!-- Edit Button -->
                                                    <a href="${pageContext.request.contextPath}/admin/quanlyblog?action=edit&id=${b.blogId}" class="w-8 h-8 bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 rounded-full inline-flex items-center justify-center">
                                                        <iconify-icon icon="lucide:edit"></iconify-icon>
                                                    </a>
                                                    
                                                    <!-- Delete Button -->
                                                    <a href="${pageContext.request.contextPath}/admin/quanlyblog?action=delete&id=${b.blogId}" onclick="return confirm('Bạn có chắc muốn xóa bài viết này không? Hành động này không thể hoàn tác.')" class="w-8 h-8 bg-danger-100 dark:bg-danger-600/25 text-danger-600 dark:text-danger-400 rounded-full inline-flex items-center justify-center">
