    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            ...
            <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
                <h6 class="text-xl font-semibold mb-0 dark:text-white">Chỉnh Sửa Tour</h6>
                <ul class="flex items-center gap-[6px]">
                    ...
                    <li class="text-neutral-500 dark:text-neutral-400 font-medium">Sửa: ${tour.title}</li>
                </ul>
            </div>
                ...
                <div class="col-span-12">
                    <div class="card border-0">
                        <div class="card-header">
                            <h5 class="text-lg font-semibold mb-0">Cập nhật thông tin</h5>
                        </div>
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/admin/quanlytour" method="post">
                                ...
                                <div class="grid grid-cols-12 gap-4">
                                    ...
                                    <div class="md:col-span-6 col-span-12">
                                        ...
                                        <input type="number" name="timeTravel" class="form-control" value="${tour.timeTravel}" required>
                                    </div>
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <div class="icon-field">
                                            ...
                                            <input type="text" name="image" class="form-control" value="${tour.image}">
                                        </div>
                                        <div class="mt-2">
                                            <span class="text-sm text-neutral-500">Hiện tại:</span>
                                            <img src="${pageContext.request.contextPath}/assets/images/products/${tour.image}" alt="Current Image" class="w-20 h-20 object-cover rounded-lg border mt-1" onerror="this.style.display='none'">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <textarea name="description" class="form-control" rows="3">${tour.description}</textarea>
                                    </div>
                                    
                                    <!-- Chi tiết -->
                                    <div class="col-span-12">
                                        <label class="form-label">Chi tiết</label>
                                        <textarea name="detail" class="form-control" rows="5">${tour.detail}</textarea>
                                    </div>
                                    
                                    <!-- Trạng thái -->
                                    <div class="col-span-12">
                                        <div class="flex items-center gap-2">
                                            <input class="form-check-input rounded-full" type="checkbox" name="active" value="true" id="activeCheck" ${tour.active ? 'checked' : ''}>
