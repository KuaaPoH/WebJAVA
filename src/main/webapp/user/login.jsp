...
<head>
    ...
    <title>Đăng Nhập - Travelin</title>
    <!-- Favicon -->
        ...
        <div class="container">
            <div class="log-main blog-full log-reg w-75 mx-auto">
                ...
                <div class="row justify-content-center">
                    <!-- LOGIN FORM -->
                    <div class="col-lg-6">
                        <h3 class="text-center border-b pb-2">Đăng Nhập</h3>
                        <form method="post" action="${pageContext.request.contextPath}/login">
                            <div class="form-group mb-2">
                                <input type="text" name="username" class="form-control" placeholder="Tên đăng nhập hoặc Email" value="${username}" required>
                            </div>
                            <div class="form-group mb-2">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <label class="custom-control-label mb-0" for="rememberMe">Ghi nhớ đăng nhập</label>
                                <a class="float-end" href="#">Quên mật khẩu?</a>
                            </div>
                            <div class="comment-btn mb-2 pb-2 text-center border-b">
                                <input type="submit" class="nir-btn" value="Đăng Nhập">
                            </div>
                            <p class="text-center">Chưa có tài khoản? <a href="${pageContext.request.contextPath}/register" class="theme">Đăng ký ngay</a></p>
                        </form>
                    </div>
                </div>
            </div>
